...
module.exports = function (app) {
    ...
    app.put('/suggestions/:suggestion_id', (req, res) => {
        ...
        connection.query(queryupdate1, [suggestion.user_id, suggestion.username, suggestion.book_id1, suggestion.booktitle1, suggestion.book_id2, suggestion.booktitle2, suggestion.reason], (err, results, fields) => {
            if (results != undefined && results.affectedRows == 0) {
